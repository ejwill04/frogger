...
// car traveling different directions, diff intervals
...
for (var i = 0; i < 5; i++) {
  x = -250 * i;
  logs.push(new Log(x, 200, 70, 10));
}


for (var i = 0; i < 5; i++) {
  x = -250 * i;
  cars.push(new Car(x, 100, 50, 50, 'right'));
}

for (var i = 0; i < 5; i++) {
  x = -250 * i;
  cars.push(new Car(x, 300, 50, 50, 'right'));
}

for (var i = 0; i < 5; i++) {
  x = 150 * i;
  cars.push(new Car(x, 200, 50, 50, 'left'));
}

for (var i = 0; i < 5; i++) {
  x = 150 * i;
  cars.push(new Car(x, 400, 50, 50, 'left'));
}
