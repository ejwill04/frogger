...
var rectW = 50;
var rectH = 50;
var frogX = (canvas.width * 0.5) - (rectW * 0.5);
var frogY = canvas.height - rectH;
...
function drawFrog() {
  ...
  if(rightPressed && frogX < canvas.width-rectW) {
    frogX += 7;
  }
  ...
  else if(downPressed && frogY < canvas.height-rectH){
    frogY += 7;
  }
}
